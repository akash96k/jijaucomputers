<?php
/**
 * Generate a complete, ready-to-import MySQL SQL dump file for Hostinger phpMyAdmin
 */

$dbPath = __DIR__ . '/../php-jijaucomputers/database/jijau.db';
$sqlFile = __DIR__ . '/../hostinger_import.sql';

$sqlite = new PDO("sqlite:" . $dbPath);
$sqlite->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

$out = "-- ========================================================\n";
$out .= "-- Jijau Computers - Complete MySQL Database Export\n";
$out .= "-- Compatible with Hostinger phpMyAdmin / MySQL 5.7+ / 8.0+\n";
...
// DDL for all tables
$ddls = [
    'WebsiteSetting' => "CREATE TABLE IF NOT EXISTS `WebsiteSetting` (
  ...
  PRIMARY KEY (`id`)
    ...
    'AdminUser' => "CREATE TABLE IF NOT EXISTS `AdminUser` (
  ...
  PRIMARY KEY (`id`)
    ...
    'CustomPcRequest' => "CREATE TABLE IF NOT EXISTS `CustomPcRequest` (
  `id` VARCHAR(191) NOT NULL,
  ...
  PRIMARY KEY (`id`)
    ...
    'ServiceRequest' => "CREATE TABLE IF NOT EXISTS `ServiceRequest` (
  `id` VARCHAR(191) NOT NULL,
  ...
  PRIMARY KEY (`id`)
    ...
    'QuotationRequest' => "CREATE TABLE IF NOT EXISTS `QuotationRequest` (
  `id` VARCHAR(191) NOT NULL,
  ...
  PRIMARY KEY (`id`)
    ...
    'HappyCustomer' => "CREATE TABLE IF NOT EXISTS `HappyCustomer` (
  `id` VARCHAR(191) NOT NULL,
  `name` VARCHAR(191) NOT NULL,
    ...
    try {
        ...
        if (!empty($rows)) {
            ...
            foreach (array_chunk($rows, 25) as $chunk) {
                $out .= "REPLACE INTO `$table` (`$colList`) VALUES\n";
                $rowStrings = [];
        ...
        $out .= "-- Error reading table $table: " . $e->getMessage() . "\n\n";
    }
}
...
echo "✅ MySQL Export Generated Successfully: $sqlFile (" . round(strlen($out) / 1024, 2) . " KB)\n";
